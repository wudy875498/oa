...
public class UserInfo {
	...
	public static final int STATUS_NO_ACTIVITY = 0;//δ����
	public static final int STATUS_NORMAL = 1;//����ʹ��
	public static final int STATUS_DISABLE = 2;//����
	public static final int STATUS_ABNORMAL = 3;//�쳣����ֹ��½��
	public static final int STATUS_FROZEN_15_MINUTE = 4;//���ᣨ15���ӣ�
	public static final int STATUS_FROZEN_30_MINUTE = 5;//���ᣨ30���ӣ�
	public static final int STATUS_FROZEN_24_HOUR = 6;//���ᣨ24Сʱ��
