...
//    private static final Logger LOG =Logger.getLogger(VerificationCodeTool.class);  
    ...
    //Chinese Numbers  
//  private static final String [] CNUMBERS = "��,һ,��,��,��,��,��,��,��,��,ʮ".split(",");  
    //��һ�����������߰˾�ʮ�˳��Ӽ�  
    ...
    private final Font font = new Font("����", Font.BOLD, 18);  
    //data operator  
...
//      g.setColor(getRandomColor(200,250));  
        ...
        getRandomMathString();  
        System.out.println("��֤�� : "+randomString);  
        System.out.println("��֤���� : "+xyresult);  
